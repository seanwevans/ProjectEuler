...
# is concerned with the squares of positive integers. Find the sum of all the numbers less than 10**8
# that are both palindromic and can be written as the sum of consecutive squares.

# Find all palindromic numbers < 10**8
# Find which are the sum of consecutive squares