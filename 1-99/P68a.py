...
#	3
#  1 2 6	
# 5			(Imagine lines connecting each number, a triangle in the middle)
#
...
# What is the maximum 16-digit string for a "magic" 5-gon ring? (A pentagon in the middle with one outcropping on each corner)
# see: http://projecteuler.net/problem=68
